Community.service('Community', ['$q','ShareService','IpfsService','ProfileDB', function ($q, ShareService, IpfsService, ProfileDB) {
    ...
    var service = {
        ...
        getPosts: function(communities){
            ...
            for(index in communities){
                ...
                ShareService.getShardEvents(communities[index]).then(
                function(events){
                    console.log(events);
                    for(index in events){
